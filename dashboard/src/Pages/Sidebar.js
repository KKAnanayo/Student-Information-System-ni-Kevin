  ...
  window.location.href = "/";
    ...
    return (
        <div className='sidebar'>
          ...
          <br/>
          <Link to = "/viewusers" style={{justifyContent: 'left', display: 'flex', color: '#FFFFFF', textDecoration: 'none'}}><VerifiedUserIcon sx={{ fontSize: 40 }}/>&nbsp;&nbsp;&nbsp;View Users</Link>
          <br/>
          ...
          <br/>
          <Link onClick={handleLogout} style={{justifyContent: 'left', display: 'flex', color: '#FFFFFF', textDecoration: 'none'}}><Logout sx={{ fontSize: 40 }}/>&nbsp;&nbsp;&nbsp;Logout</Link>
